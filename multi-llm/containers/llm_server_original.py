...
def load_model():
    ...
    # Carregar configuração EXATAMENTE COMO ESTAVA
    ...
    print(f"🔄 Carregando modelo (ORIGINAL): {model_name}")
...
if __name__ == "__main__":
    ...
    uvicorn.run("llm_server_original:app", host="0.0.0.0", port=port, workers=1)
